...
public final class Catalog {
	...
	// See JDBC chapters for info on using databases in servlets and JSP pages.
	...
	/**
	 * gets the {@link CatalogItem} with the corresponding itemID. Returns
	 * <code>null</code> if there is no item with the specified id
	 *
	 * @param itemID
